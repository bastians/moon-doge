...
/* Call this with AMOUNT 6 to place an order */
//doge_to_the_moon();
...
function doge_to_the_moon(){
	...
	if(LEVERAGE!=''){
		...
		$params = array( 'symbol' => $market['id'], 'leverage' => LEVERAGE, 'marginType' => MARGIN_TYPE);
		$leverage_response = $binance->fapiPrivate_post_leverage($params);
